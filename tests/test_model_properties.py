...
from marqo_commons.model_registry.model_properties_data.clip_properties import (
    _get_clip_properties,
)
from marqo_commons.model_registry.model_properties_data.fp16_clip_properties import (
    _get_fp16_clip_properties,
)
from marqo_commons.model_registry.model_properties_data.hf_properties import (
    _get_hf_properties,
)
from marqo_commons.model_registry.model_properties_data.languagebind_model_properties import (
    _get_languagebind_properties,
)
from marqo_commons.model_registry.model_properties_data.multilingual_clip_properties import (
    _get_multilingual_clip_properties,
)
from marqo_commons.model_registry.model_properties_data.no_model import (
    _get_no_model_properties,
)
from marqo_commons.model_registry.model_properties_data.onnx_clip_properties import (
    _get_onnx_clip_properties,
)
from marqo_commons.model_registry.model_properties_data.open_clip_properties import (
    _get_open_clip_properties,
)
from marqo_commons.model_registry.model_properties_data.random_properties import (
    _get_random_properties,
)
from marqo_commons.model_registry.model_properties_data.sbert_onnx_properties import (
    _get_sbert_onnx_properties,
)
from marqo_commons.model_registry.model_properties_data.sbert_properties import (
    _get_sbert_properties,
)
from marqo_commons.model_registry.model_properties_data.test_properties import (
    _get_sbert_test_properties,
)
from marqo_commons.model_registry.model_registry import (
    get_model_properties_dict,
    get_model_properties_json,
)
...
class TestModelProperties(TestCase):
    def test_models_count(self):
        ...
        total_count_from_all_model_properties += len(
            _get_multilingual_clip_properties()
        )
        ...
        self.assertEqual(
            ...
            total_count_from_model_registry,
    ...
    def test_all_models_have_text_modality(self):
        ...
        for model_name, model_property in model_properties.items():
            self.assertIn(
                "text",
                model_property["modality"],
                f"Model {model_name} does not have text modality",
            )
    ...
    def test_all_models_have_memory_size(self):
        ...
        for model_name, model_property in model_properties.items():
            self.assertNotIn(
                model_property["memory_size"],
                [None, 0],
                f"Model {model_name} does not have memory_size",
            )
    ...
    def test_all_model_types_are_used(self):
        ...
        model_properties = get_model_properties_dict()
        model_types = [
            model_property["type"] for model_property in model_properties.values()
        ]
        for model_type in ModelType:
            self.assertIn(
                model_type, model_types, f"Model type {model_type} is not used"
            )
    ...
    def test_serialized_and_deserialized_model_properties_are_equal(self):
        ...
        for model_name, model_property in model_properties.items():
            ...
            self.assertIn(
                model_name,
                deserialized_model_properties_json,
            ...
            for key, value in model_property.items():
                ...
                self.assertIn(
                    key,
                    deserialized_model_properties_json[model_name],
                ...
                if type(deserialized_model_properties_json[model_name][key]) is list:
                    ...
                    for item in value:
                        self.assertIn(
                            item,
                            deserialized_model_properties_json[model_name][key],
    ...
    def test_old_model_registry_matches_new(self):
        ...
        with open(
            "tests/data/old_serialized_model_registry_0df0edd2400a1b5b40598ee109f72a6ea261441b.json",
            "r",
        ) as f:
